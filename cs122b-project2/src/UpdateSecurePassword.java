...
public class UpdateSecurePassword {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String alterQuery = "ALTER TABLE user MODIFY COLUMN password VARCHAR(128)";
        int alterResult = statement.executeUpdate(alterQuery);
        System.out.println("altering user table schema completed, " + alterResult + " rows affected");
        ...
        while (rs.next()) {
            ...
            String updateQuery = String.format("UPDATE user SET password='%s' WHERE id=%s;", encryptedPassword,
                    id);
