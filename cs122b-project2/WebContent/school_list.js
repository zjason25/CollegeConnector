...
// receives a JSON array and populates school list
...
let autocomplete = getParameterByName("autocomplete");
...
jQuery.ajax({
    ...
    url: "api/school_list?school=" + schoolName+"&location=" + locationName+"&other="+ otherName+"&order="+ orderName + "&genre="+ genreName+ "&pagenum="+ pagenum+ "&whichpage="+ whichpage + "&fulltext="+fulltext + "&autocomplete="+autocomplete,// Setting request url, which is mapped by StarsServlet in Stars.java
